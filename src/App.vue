        ...
        nav.navbar.hero.is-info
          .navbar-brand
            router-link.nav-item(:to="'/'")
              span.icon
                i.fa.fa-bookmark
              span SkrzkBlogArchive
            .navbar-menu.is-active
              .navbar-end
                .navbar-item
                  a.navbar-item(href="https://twitter.com/intent/tweet?url=https://re-fort.net/SkrzkBlogArchive&text=SkrzkBlogArchive%20-")
                    span.icon
                      i.fa.fa-twitter-square.fa-2x
                  a.navbar-item(href="https://github.com/re-fort/SkrzkBlogArchive")
                    span.icon
    ...
    footer.footer
      .container
        .content.has-text-centered
          a(href="https://re-fort.net/NgzkBlogArchive")
            i.fa.fa-heart
            | NgzkBlogArchive
        .content.has-text-centered
